<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="KitapAlinti.home1" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item"><a class="nav-link" href="admin/giris.aspx">Admin Giriş</a></li>
                            <li class="nav-item"><a class="nav-link" href="GirisYap.aspx">Kullanıcı Giriş</a></li>
                            <li class="nav-item"><a class="nav-link" href="KayitOl.aspx">Üye ol</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <%--            <div class="card mb-4">
                ...
                <footer class="py-5 bg-dark">
                 <div class="container"><p class="m-0 text-center text-white">Copyright &copy; K(alıntı) 2021</p></div>
                </footer>
        </div>
    </form>
</body>
